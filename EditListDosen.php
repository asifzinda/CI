        ...
        <div class="subnavbar-inner">
            <div class="container">
               ...
               <li  ><a href="<?php base_url(); ?>home"><img src="../assets/img/icon/home.png" height="35" width="30"><span>Dashboard</span> </a> </li>
				...
				<li class="active"><a href="<?php base_url(); ?>Review"><img src="../assets/img/icon/review.png" height="35" width="30"><span>Review Judul</span> </a> </li>
    ...
    <div class="main">
        <div class="main-inner">
		  ...
		  <form>
			...
			<tr><td><b>Nama dosen  </b></td><td> <input type="text" name="nama" size="30" maxlength="50"/></td></tr>
			<br></br>
			<tr><td><b>Dosen Prodi  </b></td><td> <input type="text" name="nama" size="30" maxlength="50"/></td></tr>
			<br></br>
			<tr><td><b>Kuota<b></td><td>
			<select name="Kuota">
