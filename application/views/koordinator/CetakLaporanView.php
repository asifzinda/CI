    ...
    <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                </a><a class="brand" href="Sistem Informasi TA JTI">Sistem Informasi TA JTI </a>
            ...
            <div class="container">
                <ul class="mainnav">
                  <li  ><a href="<?php base_url(); ?>home"><img src="../assets/img/icon/home.png" height="35" width="30"><span>Dashboard</span> </a> </li>
					...
					<li class="active"><a href="<?php base_url(); ?>CetakLaporan"><img src="../assets/img/icon/cetak.png" height="35" width="30"><span>Cetak Laporan</span> </a></li>
